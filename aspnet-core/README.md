...
* Check the `ConnectionStrings` in `appsettings.json` files under the `Lakmal.Test` project and change it if you need.
...
The application needs to connect to a database. Run the following command in the `Lakmal.Test` directory to migrate the database and seed the initial data:
